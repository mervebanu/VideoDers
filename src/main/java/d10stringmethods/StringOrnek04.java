...
public class StringOrnek04 {
    public static void main(String[] args) {
        ...
        // 2- The characters must not only consist of (space) characters,
        // but also non-space characters.
        ...
        if(first){
            System.out.println("Parola hicbirsey yazmadan gecilemez");
        }
        if(second){
